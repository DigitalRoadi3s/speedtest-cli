...
def test():
        ...
        if "Cannot" in a:
                try:
                        tweet="Hey @Comcast @ComcastCares why is my internet down? I pay for 75down\\10up in Miramar Fl? #comcastoutage #comcast"
        ...
        # tweet if down speed is less than whatever I set
                ...
                try:
                        ...
                        tweet="Hey @Comcast why is my internet speed " + str(int(eval(d))) + "down\\" + str(int(eval(u))) + "up when I pay for 75down\\10up in Miramar Fl? @ComcastCares @xfinity #comcast #speedtest"
                        twit.statuses.update(status=tweet)
                except Exception,e:
                        print str(e)
                        pass
